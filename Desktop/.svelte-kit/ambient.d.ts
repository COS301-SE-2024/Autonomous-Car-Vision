...
declare module '$env/static/private' {
	...
	export const SPORTS_DB_HOST: string;
	export const SPORTS_DB_NAME: string;
	export const SPORTS_DB_PASSWORD: string;
	export const SPORTS_DB_USERNAME: string;
...
declare module '$env/dynamic/private' {
	export const env: {
		...
		SHELL: string;
		SHLVL: string;
		SPORTS_DB_HOST: string;
		SPORTS_DB_NAME: string;
		SPORTS_DB_PASSWORD: string;
		SPORTS_DB_USERNAME: string;
		SSH_ASKPASS: string;
		SYSTEMDRIVE: string;
		SYSTEMROOT: string;
		TEMP: string;
