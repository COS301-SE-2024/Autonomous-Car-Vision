    ...
    >
      <div class="flex flex-col boder border-theme-dark-backgroundBlue">
        ...
        <div class="flex mt-4 space-x-4">
          <button
            on:click={cancel}
            class="font-medium bg-opacity-70 px-4 py-2 bg-highVizLight-secondary text-white rounded-full hover:bg-opacity-100 transition-all duration-300 ease-in-out"
            >Cancel</button
          >
          <button
            on:click={deleteVideo}
            class="font-medium bg-opacity-70 px-4 py-2 bg-highVizLight-error text-white rounded-full hover:bg-opacity-100 transition-all duration-300 ease-in-out"
            >Delete</button
          >
        </div>
      </div>
