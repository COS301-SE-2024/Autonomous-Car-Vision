...
def generate_broker_ecdh_keys(aid, agent_rsa_pub_pem):
    ...
    encrypted_broker_ecdh_pub = encrypt_messageecdh(agent_rsa_pub_pem, broker_public_pem)
    return {"aid": aid, "ecdh_public_encrypted": encrypted_broker_ecdh_pub, "ecdh_private": broker_private_pem,
...
def encrypt_messageecdh(rsa_public_key_pem, ecdh_public_key_pem):
    ...
    rsa_public_key = serialization.load_pem_public_key(rsa_public_key_pem.encode('utf-8'), backend=default_backend())
