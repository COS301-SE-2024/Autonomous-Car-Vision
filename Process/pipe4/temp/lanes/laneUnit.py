...
class laneUnit(Unit):
    ...
    def follow_lane(self, out_image, filtered_results, original, previous_left_id=None, previous_right_id=None):
        bottom_length = 200
        top_length = 50
        output_image, red_line_points, selected_left_line, selected_right_line, steering_angle = self.get_lines(filtered_results, out_image)
    ...
    def start_following(self, frame, previous_left_id=None, previous_right_id=None):
        ...
        output_image, red_line_points, selected_left_line, selected_right_line, steering_angle= self.follow_lane(out_image, filtered_results, frame, previous_left_id, previous_right_id)
