CREATE TYPE CAPACITY_ENUM AS
   ...
   CREATE TABLE PROFILE ( ID SERIAL PRIMARY KEY, UID INTEGER NOT NULL, PROFILE_PHOTO VARCHAR(255) NOT NULL, PROFILE_PHOTO_MIME VARCHAR(255) NOT NULL, CREATION_DATE TIMESTAMP DEFAULT CURRENT_TIMESTAMP, FOREIGN KEY (UID) REFERENCES USERS (UID) ON DELETE CASCADE );
