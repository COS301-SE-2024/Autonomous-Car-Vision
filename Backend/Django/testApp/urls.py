...
from .views import UserViewSet, AuthViewSet, OTPViewSet, TokenViewSet, manage_auth, manage_token, manage_user, manage_otp, signup, verifyOTP, otpRegenerate, getSalt, signin, signout, hvstat, changePassword,changeUserDetails, upload_success, upload_video, list_videos, getMedia, getGalleryWithUid
...
urlpatterns = [
    ...
    path('getMedia/', getMedia, name='getMedia'),
    path('getGalleryWithUid/', getGalleryWithUid, name='getGalleryWithUid')
]
